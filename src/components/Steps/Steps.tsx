...
const Steps: FC<StepsProps> = ({ currentStep }) => {
  const currentClassName = (value: boolean) => {
    if (value) {
      return 'p-2 border-blue-600 border-2 rounded-xl w-44 text-center';
    }
    return 'p-2 border-gray-300 bg-slate-300 opacity-50 border-2 rounded-xl w-44 text-center';
  };
